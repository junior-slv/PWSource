...
static const char* l_szClassName = "$$root$$ Class";

static int l_iRenderWid = $$RENDER_WIDTH$$;
static int l_iRenderHei = $$RENDER_HEIGHT$$;
static bool l_bFullScreen = $$FULLSCREEN$$;
...
bool _CreateMainWnd(HINSTANCE hInstance, int nCmdShow)
{
	...
	DWORD dwExStyle = 0;
	const char* l_szWndName = "$$root$$ Window";
