...
#define EPSILON_NORMAL		1e-5f		//	Epsilon of normal
...
*/
void MakePlaneFromPoints(const A3DVECTOR3& v1, const A3DVECTOR3& v2, const A3DVECTOR3& v3,
						 s_PLANE* pPlane)
{
	A3DVECTOR3 d1 = v2 - v1;
	A3DVECTOR3 d2 = v3 - v1;
...
void SnapVector(A3DVECTOR3& vNormal)
{
	for (int i=0; i < 3; i++)
	{
		if (vNormal.m[i] > 1.0f - EPSILON_NORMAL)
		{
